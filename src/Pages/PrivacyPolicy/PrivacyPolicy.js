...
const PrivacyPolicy = () => {
  ...
  return (
    <div className="grid grid-cols-1 container mx-auto lg:mt-40 mt-20 mb-20 px-5">
      <img src={privacy} className="w-70 mx-auto " alt="Privacy Policy" />
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Insaf Foundation LTD, 22 Rawson
            Street,Rockdale NSW-2216. Sydney Australia.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Insaf Foundation, accessible from{" "}
            <Link>https://Insaffoundation.org/</Link>
          </p>
        </li>
        <li>
          <p>
      ...
      <ul>
        <li>
          <p>By email: info@insaffoundation.org</p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>By phone number: +88 01780-299384</p>
        </li>
        <li>
          <p>
            By mail: 9/A , Rupayan Z.R Plaza, Level - 2 Road No. New 46,
            Satmasjid Road, Dhanmondi, Dhaka 1209
          </p>
        </li>
      </ul>
    </div>
