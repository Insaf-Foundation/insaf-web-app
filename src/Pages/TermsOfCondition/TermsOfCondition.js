...
const TermsOfCondition = () => {
  useTitle("Terms Of Condition");
  return (
    <div className="container mx-auto mt-40 pb-10 px-5">
      <div>
        <h2>Website Terms of Use</h2>

        <img src={terms} alt="Terms Of Conditions " className="mx-auto" />

        <p>Version 1.0</p>

        <p>
          The www.insaffoundation.org website located at{" "}
          <Link to="https://www.insaffoundation.org/">
            https://www.insaffoundation.org/
          </Link>{" "}
          is a copyrighted work belonging to Insaf Foundation. Certain features
        ...
        <p>
          ...
          <a href="https://www.termsfeed.com/terms-use-generator/">
        ...
        <p>
          ...
          the Company should be sent to: 22 Rawson Street,Rockdale NSW-2216.
          Sydney Australia. After the Notice is received, you and the Company
        ...
        <p>
          ...
          to the personal jurisdiction of the courts located within bd County,
        ...
        <p>Email: info@insaffoundation.org</p>
      </div>
    </div>
  );
};
