...
const CookiePolicy = () => {
  ...
  return (
    <div className="container mx-auto  mt-40 px-5 pb-10">
      <h1>Cookie Policy for Insaf Foundation</h1>

      <img src={cookie} alt="Cookie Policy" className="mx-auto " />

      <p>
        This is the Cookie Policy for Insaf Foundation, accessible from{" "}
        <Link className="link" to="https://insaffoundation.org">
      ...
      <p>
        ...
        <Link to="https://www.cookiepolicygenerator.com/sample-cookies-policy/">
      ...
      <ul>
        <li>Email: info@clippingpathhero.com</li>
        <li>
